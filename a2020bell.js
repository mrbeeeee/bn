        ...
        var timex = chour + "." + cminute;
            ...
            if (n == 2020) {
                ...
                if (timex >= 1.00 && timex < 8.00) {
                    ...
                    bmessage = "Period 5A (Class) - 11:40 to 12:10"
                    period = "Period 5A"
                    var timel = "12:10:00";
                    classis = false;
                    ...
                    bmessage = "Period 5B (Study Hall) - 12:15 to 12:45"
                    period = "Period 5B"
                    var timel = "12:45:00";
                    classis = false;
                    ...
                    bmessage = "Period 6A (Either Lunch or Study Hall) 12:55 PM to 1:25 PM"
                    period = "Period 6A"
                    var timel = "13:25:00";
                    classis = true;
                    ...
                    bmessage = "Period 6B (Either Lunch or Study Hall) - 1:30 PM to 2:00 PM"
                    period = "Period 6B"
                    var timel = "14:00:00";
                    classis = true;
