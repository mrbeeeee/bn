        ...
        var timex = chour + "." + cminute;
            ...
            if (n == 2020) {
                ...
                if (timex >= 1.00 && timex < 8.00) {
                    ...
                    bmessage = "Period 5 (Middle School Lunch) - 11:20 to 11:50"
                    period = "Period 5"
                    var timel = "12:50:00";
                    classis = false;
                } else if (timex >= 11.50 && timex < 12.35) {
                    period = "Take 45 Minutes off. We're back at 12:35"
                    bmessage = "P5 to P6 Intermission -  11:50 to 12:35"
                    var timel = "12:25:00";
                    classis = false;
